...
function ChannelStats({ stats }) {
    ...
    return (
        <>
            <div className="flex flex-wrap justify-between text-gray-200 gap-4">
                <div className="block">
                ...
                <div className="block">
                    ...
                    <button
                        ...
                        className="mt-4 inline-flex items-center gap-x-2 border-1 border-gray-700 hover:bg-pink-700  rounded-xl hover:border-gray-600 px-3 py-1.5 font-semibold text-gray-200"
                    >
            ...
            <div className="grid grid-cols-[repeat(auto-fit,_minmax(220px,_1fr))]  gap-3">
                <InfoBox className="border-gray-700"
                    key="total-videos"
                    title="Total Videos"
